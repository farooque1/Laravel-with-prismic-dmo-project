                ...
                <nav class="navbar navbar-expand-sm navbar-light ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <form class="form-inline my-2 my-lg-0">
                                <ul class="navbar-nav mr-auto">
                <li class="nav-item active"><a class="nav-link" href="#">Типы виз <i style="font-size:17px;color:red; " class="fa">&#xf107;</i></a></li>
                <li class="nav-item active"><a class="nav-link" href="#">Общая информация <i style="font-size:17px;color:red;" class="fa">&#xf107;</i></a></li>
                <li class="nav-item active"><a class="nav-link" href="#" >Дополнительные услуги</a></li>
                <li class="nav-item active"><a class="nav-link" href="#">Новости и обновления </a></li>
                <li class="nav-item active"><a class="nav-link" href="#">Сервис <i style="font-size:17px;color:red;" class="fa">&#xf107;</i></a></li>
                <li class="nav-item active"><a class="nav-link" href="#">Вопросы и ответы</a></li>
                
                <li class="nav-item active"><a class="nav-link" href="#"><img src="https://images.prismic.io/visa/421402f5-990b-4334-b3b9-62bfcedfc643_plane.png" style="margin-left:6em;width:1.85rem;"></a></li>
                                </ul>
                <div class="dropdown">
...
<div id="background">
        <div class="container mb-5">
            <img src="https://images.prismic.io/artionis-ru/e0e744bd-2ba2-4ef5-afa6-f4cef4a1f04c_russia.jpg" style="width:69rem;height:400px;object-fit:cover;">
                <span style="position: absolute;top:55%;-webkit-transform:translateY(-50%);transform:translateY(-50%);left: 10%;font-size:40px;text-align:center;width: 80%;font-family: GTSectraDisplay,serif;z-index:2;color:#fff;font-weight:100;display: inline-block;line-height: 5rem;"><p>Узнай как просто получить визу в Россию</p></span>
...
<div class="container mt-5">
    <div class="row">
        <div class="col-lg-7 col-md-12 col-xs-12 mb-5 mt-5">
            ...
            <h6 class="desgin mt-5"><a href="{{ Request::root() }}/covid-19/covid">Уведомление COVID-19




</a> </h6>
            <div class="post__published">Опубликовано 27/8/2020</div>
            <h6 class="desgin1 mt-4"><a href="">О порядке пересечения иностранными гражданами и<br> лицами без гражданства российско-белорусского<br> участка Государственной границы РФ.
            </a></h6>
            <div class="post__published">Опубликовано 8/10/2018</div>

            <button type="button" class="btn mt-2">Ещё новости &nbsp;&nbsp;<i style="font-size:17px;color:red;" class="fa"> &#xf105;</i></button>
        </div>
    ...
    <li><a href="">Деловая виза</a></li><br>
    <li><a href="">Туристическая виза</a></li><br>
    <li><a href="">Рабочая виза</a></li><br>
    <li><a href="">Частная виза </a></li><br>
    <li><a href="">Гуманитарная виза </a></li><br>
    <li><a href="">Учебная виза</a></li><br>
    <li><a href="">Tранзитная виза</a></li>
   </ul>
        </div>        
    </div>
...
<hr style="height:2px;border-width:0.0em;color:lightgray;background-color:lightgray;">
     <div data-wio-id="{{ $document->id }}">
              <h1 class=" mt-5 mb-5">{{ RichText::asText($document->data->title) }}</h1>
        <div>
            <ol>
                <li>
                    <strong>{!! RichText::asHtml($document->data->title1) !!}</strong>
                    {!! RichText::asHtml($document->data->para1) !!}
                </li>
                <li>
                    <strong>{!! RichText::asHtml($document->data->title2) !!}</strong>        {!! RichText::asHtml($document->data->para2) !!}    
                </li>
                <li>
                    <strong>{!! RichText::asHtml($document->data->title3) !!}</strong>
                              {!! RichText::asHtml($document->data->para4) !!}
                </li>
            </ol>
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        <p class="card-text"><a href="https://mid.ru/ru/home">Посольство Российской<br> Федерации в Австрийской<br> Республике
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        <p class="card-text"><a href="https://mid.ru/ru/home">Министерство иностранных<br> дел Российской<br> Федерации
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        <p class="card-text"><a href="">Генеральное консульство <br>Российской Федерации в <br>Зальцбурге
